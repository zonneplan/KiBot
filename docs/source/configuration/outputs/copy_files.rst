   ...
   -  Valid keys:
      ...
      -  **files** :index:`: <pair: output - copy_files - options; files>` [:ref:`list(dict) <list(dict)>`] Which files will be included.
         ...
         -  Valid keys:
            ...
            -  **source_type** :index:`: <pair: output - copy_files - options - files; source_type>` [:ref:`string <string>`] (default: ``'files'``) From where do we get the files to be copied.
...
-  ``priority`` :index:`: <pair: output - copy_files; priority>` [:ref:`number <number>`] (default: ``11``) Priority for this output. High priority outputs are created first.
